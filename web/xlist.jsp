    ...
    <div class="panel admin-panel">
        ...
        <table class="table table-hover text-center">
            ...
            <volist name="list" id="vo">
                <ls:forEach var="ss" items="${requestScope.findAllx}" varStatus="gl">
                    <tr>
                        <td>${ss.id}</td>
                        <td>${ss.bid}</td>
                        <td>${ss.sid}</td>
        ...
        <div class="button-group"><a class="button border-main" href="findAllx?operation=-"><span class="icon"></span>
            上一页</a> <a class="button border-red" href="findAllx?operation=+"><span class="icon"></span> 下一页</a></div>
        </td>
    </div>
</form>
